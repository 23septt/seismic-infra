...
# Allow running from repo root: python -m pytest seismoguard/tests/
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", ".."))

from seismoguard import config
from seismoguard.sensors.seismic import compute_sta_lta, _classify_mpd, _estimate_magnitude
